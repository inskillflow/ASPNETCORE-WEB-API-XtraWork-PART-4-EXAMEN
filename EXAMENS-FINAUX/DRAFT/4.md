...
**Duree** : 90 minutes
**Type** : Questions ouvertes avec analyse de code
**Bareme** : Variable par question (total 100 points)

**Analysez les extraits de code du projet XtraWork et repondez aux questions.**
